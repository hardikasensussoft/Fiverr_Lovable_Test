...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    try {
      personalizedContent = await generatePersonalizedContent(name, industry);
      ...
      personalizedContent = `Hi ${name}! 🚀 Welcome to our innovation community! We're thrilled to have someone from the ${industry} industry join us. Get ready to discover cutting-edge insights, connect with fellow innovators, and unlock new opportunities that will transform how you work. This is just the beginning of your innovation journey!`;
    }

    const emailResponse = await resend.emails.send({
      from: "Innovation Community <hardika@resend.dev>",
      to: [email],
